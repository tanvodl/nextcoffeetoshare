      ...
      <div className="md:max-w-screen-2xl md:px-4">
        <div className="flex justify-between items-center py-6 md:justify-between md:space-x-10 md:space-y-2">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-yellow-800">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-brown-lighter'
                    )}
                  >
                    <span>Kiếm tiền Online</span>
                    <ChevronDownIcon
                      className={classNames(
                        open ? 'text-gray-600 hover:text-brown-lighter' : 'text-gray-400 hover:text-brown-lighter',
                        'ml-2 h-5 w-5 group-hover:text-brown-lighter'
                      )}
                      aria-hidden="true"
                    />
                  </Popover.Button>
                  ...
                  >
                    <Popover.Panel className="absolute z-0 md:z-50 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                          {solutions.map((item) => (
                            <a
                              key={item.name}
                              href={item.href}
                              className="-m-3 p-3 flex items-start rounded-lg hover:text-white hover:bg-brown-lighter"
                            >
                              <item.icon className="flex-shrink-0 h-6 w-6 text-yello-600" aria-hidden="true" />
                              <div className="ml-4">
                        ...
                        <div className="px-5 py-5 bg-white space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8 hover:bg-brown-lighter">
              ...
              {({ open }) => (
                <>
                  <Popover.Button
                    className={classNames(
                      open ? 'text-gray-900' : 'text-gray-500',
                      'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-brown'
                    )}
                  >
                    <span>Đồ nghề cần thiết</span>
                    <ChevronDownIcon
                      className={classNames(
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0 translate-y-1"
                  >
                    <Popover.Panel className="absolute z-50 md:z-50 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
            ...
            <a href="../posts" className="text-base font-medium text-gray-500 hover:text-brown-lighter ">
              Blog
            </a>
            <a href="#" className="text-base font-medium text-gray-500 hover:text-brown-lighter">
              Cà phê với tụi mình
            </a>
          </Popover.Group>
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
              href="#"
              className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-bold text-white bg-black hover:text-white hover:bg-brown-lighter"
            >
              NHẬN TIN HAY!
            </a>
          </div>
